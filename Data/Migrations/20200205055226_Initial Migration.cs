        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarCategoryName = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    MotorcycleCategoryName = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleType = table.Column<string>(nullable: false),
                    ...
                    WheelDriveType = table.Column<string>(nullable: false),
                    InteriorColor = table.Column<string>(nullable: false),
                    NumberOfAirbags = table.Column<int>(nullable: false),
                    SteeringWheelPosition = table.Column<string>(nullable: false),
                    Description = table.Column<string>(nullable: false),
                    SellerName = table.Column<string>(nullable: false),
                    SellerNumber = table.Column<int>(nullable: false),
                    ...
                    HasAlarm = table.Column<bool>(nullable: false),
                    HasElectricMirrors = table.Column<bool>(nullable: false),
                    HasLeatherInterior = table.Column<bool>(nullable: false),
                    HasClimateControl = table.Column<bool>(nullable: false),
                    HasHesatedSeats = table.Column<bool>(nullable: false),
                    HasNavigation = table.Column<bool>(nullable: false),
                    HasAirConditioning = table.Column<bool>(nullable: false),
                    HasParkingControl = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    MotorcycleCategoryId = table.Column<int>(nullable: false),
                    Make = table.Column<string>(nullable: false),
                    Model = table.Column<string>(nullable: false),
                    SaleType = table.Column<string>(nullable: false),
                    ProductionYear = table.Column<int>(nullable: false),
                    ...
                    HasTCS = table.Column<bool>(nullable: false),
                    HasAlarm = table.Column<bool>(nullable: false),
                    HasElectricStarter = table.Column<bool>(nullable: false),
                    HasStartStop = table.Column<bool>(nullable: false),
                    HasLuggage = table.Column<bool>(nullable: false),
                    HasWindshiled = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
